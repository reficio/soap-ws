...
public class ResourceUtilsTest {
    ...
    public void testResourceLoadingObject() {
        InputStream stream = ResourceUtils.getResourceWithAbsolutePackagePathAsStream(Object.class, "/com/centeractive/ws/common/test/", "soapEncoding.xsd");
        Assert.assertNotNull(stream);
    }
    ...
    public void testResourceLoadingGetClass() {
        InputStream stream = ResourceUtils.getResourceWithAbsolutePackagePathAsStream(getClass(), "/com/centeractive/ws/common/test/", "soapEncoding.xsd");
        Assert.assertNotNull(stream);
    }
    ...
    public void testResourceLoadingNotNormalizedNoClass() {
        URL url = ResourceUtils.getResourceWithAbsolutePackagePath("com/../com/centeractive/../centeractive/ws/common/test/", "soapEncoding.xsd");
        Assert.assertNotNull(url);
    }
